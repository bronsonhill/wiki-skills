...
% Build:  bash "${CLAUDE_PLUGIN_ROOT}/skills/practice-exam/build.sh" this-file.tex
...
\firstpageheader{SUBJECT NAME}{}{Practice Exam}
\runningheader{SUBJECT CODE}{Practice Exam}{\thepage}
